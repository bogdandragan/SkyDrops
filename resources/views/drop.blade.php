...
<div class="subHeader">
	<div class="container wrap">
		<div class="subHeaderLeftBlock">
			@if(Auth::check())
				<i class="fa fa-2x fa-inbox titleIcon"></i><span id="dropTitle" contenteditable="true" title="Click to rename drop">@if($drop->title) {{ $drop->title }} @else {{ $drop->hash }} @endif</span>
			@else
